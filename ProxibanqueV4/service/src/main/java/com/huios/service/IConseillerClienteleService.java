...
public interface IConseillerClienteleService {
	...
	/**
	 * Méthode qui permet d'ajouter un compte epargne à un client en base de
	 * données
	 * 
	 * @param idClient
	 *            identifiant client
	 * @param compteEpargne
	 *            compte epargne à ajouter
	...
	/**
	 * Méthode qui permet d'ajouter un compte courant à un client en base de
	 * données
	 * 
	 * @param idClient
	 *            identifiant client
	 * @param compteCourant
	 *            compte courant à ajouter
	...
	/**
	 * Méthode qui permet de récuperer la liste des comptes d'un client en base
	 * de données
	 * 
	 * @param idClient
	 *            identifiant client
	...
	/**
	 * Méthode qui permet de récupérer tous les comptes de la banque sauf celui
	 * déjà selectionné
	 * 
	 * @param compte
	 *            compte selectionné
	...
	/**
	 * Méthode quui permet de modifier un client qui existe déjà en base de
	 * données
	 * 
	 * @param c
	 *            Client à modifier
	...
	/**
	 * Méthode qui permet de modifier un compte qui existe déjà en base de
	 * données
	 * 
	 * @param compte
	 *            Compte à modifier
	 ...
	 * 
	 * @param idCompte
	 *            identifiant du compte à supprimer
	 * @throws CompteInexistantException
	 */
	...
	/**
	 * Méthode qui permet d'alerter le conseiller par rapport aux compte de ses
	 * clients qui sont à découvert
	 * 
	 * @param idConseiller
	 *            identifiant du conseiller
	 * @return La liste d'alertes à afficher
	 */
