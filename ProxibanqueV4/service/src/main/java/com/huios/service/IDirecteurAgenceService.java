...
public interface IDirecteurAgenceService {
	 ...
	 * @return Personne (directeur d'agence)
	...
	/**
	 * Méthode permettant au directeur de lister toutes les alertes concernant les conseillers dont il a la responsabilité
	 * 
	 * @param idDirecteur : id du directeur d'agence
