...
public interface IDirecteurAgenceService {
	 ...
	 * 
	 * @param idDirecteurAgence
	 *            identifiant du directeur
	 * @param conseiller
	 *            conseiller à ajouter en base
	 */
	public void ajouterConseiller(int idDirecteurAgence, ConseillerClientele conseiller);

	/**
	 * Méthode qui permet à un directeur de récupérer un conseiller en base
	 * données
	 * 
	 * @param idConseiller
	...
	/**
	 * Méthode qui permet à un directeur de récuperer ses conseillers en base de
	 * données
	 * 
	 * @param idDirecteur
	 *            identifiant du directeur
	...
	/**
	 * Méthode qui permet à un directeur de modifier un de ses conseillers en
	 * base de données
	 * 
	 * @param c
	...
	/**
	 * Méthode qui permet de supprimer un conseiller existant en base de données
	 * par son identifiant
	 * 
	 * @param idConseiller
	 *            identifiant conseiller
	...
	/**
	 * Méthode qui permet de faire un rapport de transaction sur les mois
	 * précédents
	 * 
	 * @param nbMois
	 *            nombre de mois pour le rapport
	 * @return retourne une liste de transactions
	 */
	public List<Transaction> rapportTransactionMois(int nbMois);

	/**
	 * Méthode qui permet de faire un rapport de transaction sur la dernière
	 * semaine
	 * 
	...
	/**
	 * Méthode permettant au directeur de lister toutes les alertes concernant
	 * les conseillers dont il a la responsabilité
	 * 
	 * @param idDirecteur
	 *            id du directeur d'agence
	 * @return La liste des alertes des conseillers gérés par le directeur
	 */
